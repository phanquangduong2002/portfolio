...
const Cursor = () => {
    ...
    return (
        <div
            ref={cursorRef}
            className="w-7 h-7 bg-transparent border-[1px] border-orange-600 rounded-full fixed z-50 -translate-x-1/2 -translate-y-1/2 pointer-events-none hidden transition duration-75"
        ></div>
    );
};
