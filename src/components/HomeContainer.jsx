...
const HomeContainer = () => {
    return (
        <section
            id="#home"
            className="w-full h-auto lg:h-screen min-w-[320px] lg:max-h-[600px] flex justify-center items-start lg:items-stretch lg:justify-self-stretch bg-home_bg_image bg-cover bg-center bg-no-repeat relative"
        >
